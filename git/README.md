...
-  [How Git Works](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#how-git-works)
-  [Installation](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#installation)
-  [Create Repository](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#create-repository)
-  [Configuration](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#configuration)
-  [Staging And Commiting](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#staging-and-commiting)
-  [Git Diff](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-diff)
-  [Git Status And Log](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-status-and-log)
-  [Git Tag](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-tag)
-  [Git Blame](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-blame)
-  [Undoing Changes](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#undoing-changes)
-  [Rewriting History](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#rewriting-history)
-  [Git Reflog](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-reflog)
-  [Git Stash](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-stash)
-  [Collaborating](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#git-collaborating)
-  [Branching](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#branching)
-  [Advanced](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#advanced)
-  [Patches](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#patches)
-  [Literature](https://github.com/fprotopapa/git-cheatsheet/blob/main/git#literature)
